...
// Google OAuth removed (no Supabase)
function GoogleAuthComponent() { return null; }
...
function ResetPasswordForm({ onBackToLogin }) {
  ...
  const submit = async () => {
    ...
    setLoading(true);
    try {
      setSuccess("Password reset is not supported in local mode. Please contact your administrator.");
      setCountdown(3);
    } catch (err) {
