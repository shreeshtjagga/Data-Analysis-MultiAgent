...
class UserRegister(BaseModel):
    model_config = ConfigDict(json_schema_extra={'example': {'name': 'John Doe', 'email': 'user@example.com', 'password': 'securepassword123'}})
...
class UserLogin(BaseModel):
    model_config = ConfigDict(json_schema_extra={'example': {'email': 'user@example.com', 'password': 'securepassword123'}})
    email: EmailStr
    password: str
