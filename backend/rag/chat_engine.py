...
def _data_system_prompt(file_name: str, chart_keys: list[str]) -> str:
    parts = [
        ...
        'FORMAT RULES:\n',
        '- Always open with a bold **direct answer** line\n',
        '- Use bullet points (starting with •) for all details after that line\n',
        '- Each bullet must contain at least one specific number\n',
        '- 3 to 5 bullets max — never more\n',
        '- Use **bold** only for the direct answer and key numbers\n\n',
